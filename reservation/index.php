...
<body>
			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">
							<h6>SPARTAN</h6> <span>BOXING</span>
							<p class="logo_w3l_agile_caption">FITNESS WAREHOUSE</p>
						</a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="" class="menu__link"><img src="images/home.png"></a></li>
							<!-- <li class="menu__item"><a href="#about" class="menu__link scroll">About</a></li>
							<li class="menu__item"><a href="#team" class="menu__link scroll">Team</a></li> -->
							<li class="menu__item"><a href="#gallery" class="menu__link scroll"><img src="images/gallery.png"></a></li>
							<li class="menu__item"><a href="#rooms" class="menu__link scroll"><img src="images/about.png"></a></li>
							<!-- <li class="menu__item"><a href="#contact" class="menu__link scroll">Contact Us</a></li> -->				
							
							<div class="dropdown">
								<button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<?php echo 'Rolly Labuanan Jr'; ?>
								</button>
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									<a class="dropdown-item" href="#"><img src="images/face.png">&nbsp;Proifle</a>
									<br>
									<a class="dropdown-item" href="#"><img src="images/card.png">&nbsp; Status</a>
									<hr>
									<a class="dropdown-item" href="#"><img src="images/log.png">&nbsp; Logout</a>
								</div>
							</div>
						</ul>
					</nav>
	...
	<div id="home" class="w3ls-banner">
						...
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								<div class="agileits-banner-info">
									<h3>SPARTAN BOXING AND FITNESS WAREHOUSE</h3>
						...
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
									...
									<div class="agileits_w3layouts_more menu__item styl">
										<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Learn More</a>
									</div>
								</div>
							</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<center>
							<p>Providing guests unique and enchanting views from their rooms
								with its exceptional amenities, makes Star Hotel one of bests in
								its kind.Try our food menu, awesome services and friendly staff while
								you are here.</p>
						</center>
					</div>
				</div>
		...
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About SPARTAN BOXING AND FITNESS WAREHOUSE</h3>
				<p class="about-para-w3ls">Patutong Malaki South, tagaytay-Mendez Road. in between La Mariposa and
					Tropical Green, Look for the Red gate, 4120 Tagayatay City, Philippines</p>
		...
		<section class="portfolio-w3ls" id="gallery">
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area1.jpg" class="swipebox"><img src="images/area1.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area2.jpg" class="swipebox"><img src="images/area2.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN </h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area3.jpg" class="swipebox"><img src="images/area3.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area4.jpg" class="swipebox"><img src="images/area4.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area5.jpg" class="swipebox"><img src="images/area5.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area10.jpg" class="swipebox"><img src="images/area10.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area9.jpg" class="swipebox"><img src="images/area9.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area11.jpg" class="swipebox"><img src="images/area11.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area12.jpg" class="swipebox"><img src="images/area12.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
			...
			<div class="col-md-3 gallery-grid gallery1">
				<a href="images/area13.jpg" class="swipebox"><img src="images/area13.jpg" class="img-responsive" alt="/">
					<div class="textbox">
						<h4>SPARTAN</h4>
						<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					</div>
		...
		<!-- <div class="plans-section" id="rooms">
			<div class="container">
				<h3 class="title-w3-agileits title-black-wthree">Reservation Event</h3>
				<div class="priceing-table-main">
					<div class="col-md-3 price-grid">
						<div class="price-block agile">
							<div class="price-gd-top">
								<img src="images/basketball.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-3 price-grid ">
						<div class="price-block agile">
							<div class="price-gd-top">
								<img src="images/boxing.jpg" alt=" " class="img-responsive" />
								<h4>Boxing Ring</h4>
							</div>
							<div class="price-gd-bottom">
								<div class="price-selet">
	...
	<div class="copy">
		<p>© 2021 . All Rights Reserved | Design by <a href="index.php">Student of City college of tagayatay</a> </p>
	</div>
	<!--/footer -->
	<!-- js -->
