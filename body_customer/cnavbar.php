...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="customer.php">
        ...
        <div class="sidebar-brand-text mx-0">
            <h6> Spartan boxing & fitness warehouse </h6>
        </div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="customer_generate.php">Generate QR Code</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="customer_form.php">Make Reservation</a>
                <a class="collapse-item" href="customer_membership.php">Make Membership</a>
            </div>
        </div>
    </li>
