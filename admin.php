...
<!-- Page Heading -->
        ...
        <div class="container-fluid">
            <div class="card shadow mb-4">
                ...
                <?php
                $query = "SELECT * FROM tbl_customer WHERE role = 'Member' ";
                $query_run = mysqli_query($connection, $query);
                ?>
                        ...
                        if (mysqli_num_rows($query_run) > 0) {
                            while ($row = mysqli_fetch_assoc($query_run)) { ?>
                                <tr>
                                    ...
                                    <td><?php
                                        if ($row['status'] == 1) {
                                            echo '<p><i class="fa fa-circle text-success"></i><a href="mem_status.php?id=' . $row['id'] . '&status=0">Enable</a></p>';
                                        } else {
                                            echo '<p><i class="fa fa-circle text-danger"></i><a href="mem_status.php?id=' . $row['id'] . '&status=1">Disable</a></p>';
                                        }
                                        ?></td>
                                </tr>
                        <?php
